...
<html lang="zh-CN">
  ...
  <body>
			  ...
			  <div class="panel-body">
				<form id="editPermissionForm">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" value="${ permission.name }" placeholder="请输入名称">
				  </div>
				  <div class="form-group">
					<label for="icon">图标</label>
					<input type="text" class="form-control" id="icon" name="icon" value="${ permission.icon }" placeholder="请输入图标">
				  </div>
				  <div class="form-group">
					<label for="url">路径</label>
					<input type="text" class="form-control" id="url" name="url" value="${ permission.url }" placeholder="请输入路径">
				  </div>
				  <button type="button" id="doupdateBtn" class="btn btn-success" onclick="doupdate()" pid="${ permission.id }" ><i class="glyphicon glyphicon-edit"></i> 修改</button>
    ...
    <script type="text/javascript">
        ...
        function doupdate(){
        	...
        	$.ajax({
        		...
        		success:function(result){
        			if(result.success){
        				window.location.href="${APP_PATH}/permission/index.htm?pageno=${param.pageno}";
        			} else {
        ...
        function reset(){
        	$("#name").val($("#name").attr("oldvalue"));
        	$("#icon").val($("#icon").attr("icon"));
        	$("#url").val($("#url").attr("oldvalue"));
        }
