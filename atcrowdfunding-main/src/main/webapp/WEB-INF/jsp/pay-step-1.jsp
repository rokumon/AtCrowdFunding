                        ...
                        <div class="container-fluid">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-12 column">
                                    ...
                                    <button type="button" class="btn btn-warning btn-lg" style="float:right;" onclick="window.location.href='pay-step-2.html'"><i class="glyphicon glyphicon-credit-card"></i> 去结算</button>
                                    </div>
                                </div>
