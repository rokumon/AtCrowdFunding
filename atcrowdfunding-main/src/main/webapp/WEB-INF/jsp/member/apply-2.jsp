    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
          ...
          <button type="button" onclick="window.location.href='${APP_PATH}/member/apply-1.htm'" class="btn btn-default">上一步</button>
		  <button type="button" onclick="window.location.href='${APP_PATH}/member/apply-3.htm'"  class="btn btn-success">下一步</button>
		</form>
		<hr>
    </div> <!-- /container -->
