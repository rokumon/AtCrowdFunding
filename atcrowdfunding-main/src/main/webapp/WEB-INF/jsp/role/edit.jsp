			  ...
			  <div class="panel-body">
				<form role="form">
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="rnamr" name="rname" oldvalue="${ requestScope.role.name }" value="${ requestScope.role.name }">
				  </div>
				  <button type="button" id="doupdateBtn" class="btn btn-success" onclick="doupdate()" rid="${ requestScope.role.id }" ><i class="glyphicon glyphicon-edit"></i> 修改</button>
